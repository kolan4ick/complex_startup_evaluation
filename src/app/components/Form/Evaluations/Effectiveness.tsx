                        ...
                        <tr key={index}>
                            <td className="border border-gray-300 px-4 py-2">
                                <input
                                    type="number"
                                    step={0.01}
                                    {...register(`evaluation.effectiveness.sum.${index}`)}
                            ...
                            <td className="border border-gray-300 px-4 py-2">
                                <input
                                    type="number"
                                    step={0.01}
                                    {...register(`evaluation.effectiveness.min.${index}`)}
                                    className="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                />
                            </td>
                            <td className="border border-gray-300 px-4 py-2">
                                <input
                                    type="number"
                                    step={0.01}
                                    {...register(`evaluation.effectiveness.max.${index}`)}
                                    className="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                />
                            </td>
                            <td className="border border-gray-300 px-4 py-2">
                                <input
                                    type="number"
                                    step={0.01}
                                    {...register(`evaluation.effectiveness.desired.${index}`)}
                                    className="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                />
                            </td>
                            <td className="border border-gray-300 px-4 py-2">
                                <input
                                    type="number"
                                    step={0.01}
                                    {...register(`evaluation.effectiveness.weight.${index}`)}
                                    className="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                />
                            </td>
                        </tr>
