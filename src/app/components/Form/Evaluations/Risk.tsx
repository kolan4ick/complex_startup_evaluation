                    ...
                    >
                        ...
                        <div className="flex-1">
                            <input
                                ...
                                {...register(`risk_operational_scores_attributes.${index}.authenticity`, authenticityValidation)}
                            ...
                            />
                            <div className="h-5">
                                {errors.risk_operational_scores_attributes?.[index]?.authenticity && (
                                    <p className="text-red-600 text-sm">
                                        {errors.risk_operational_scores_attributes[index].authenticity.message}
                                    </p>
                                )}
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <input
                                ...
                                step={0.01}
                                placeholder={t('placeholders.authenticity')}
                                {...register(`risk_investment_scores_attributes.${index}.authenticity`, authenticityValidation)}
                                className="w-full border border-gray-300 dark:border-gray-700 rounded-lg px-4 py-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-50 dark:bg-gray-800 text-gray-800 dark:text-gray-200"
                            />
                            <div className="h-5">
                                {errors.risk_investment_scores_attributes?.[index]?.authenticity && (
                                    <p className="text-red-600 text-sm">
                                        {errors.risk_investment_scores_attributes[index].authenticity.message}
                                    </p>
                                )}
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <input
                                ...
                                step={0.01}
                                placeholder={t('placeholders.authenticity')}
                                {...register(`risk_financial_scores_attributes.${index}.authenticity`, authenticityValidation)}
                                className="w-full border border-gray-300 dark:border-gray-700 rounded-lg px-4 py-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-50 dark:bg-gray-800 text-gray-800 dark:text-gray-200"
                            />
                            <div className="h-5">
                                {errors.risk_financial_scores_attributes?.[index]?.authenticity && (
                                    <p className="text-red-600 text-sm">
                                        {errors.risk_financial_scores_attributes[index].authenticity.message}
                                    </p>
                                )}
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <input
                                ...
                                step={0.01}
                                placeholder={t('placeholders.authenticity')}
                                {...register(`risk_innovation_activity_scores_attributes.${index}.authenticity`, authenticityValidation)}
                                className="w-full border border-gray-300 dark:border-gray-700 rounded-lg px-4 py-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-50 dark:bg-gray-800 text-gray-800 dark:text-gray-200"
                            />
                            <div className="h-5">
                                {errors.risk_innovation_activity_scores_attributes?.[index]?.authenticity && (
                                    <p className="text-red-600 text-sm">
                                        {errors.risk_innovation_activity_scores_attributes[index].authenticity.message}
                                    </p>
                                )}
                            </div>
                        </div>
